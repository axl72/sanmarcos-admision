...
path = "scrapers.sanmarcos_generic_scraper" # Reemplaza con el path correcto a tu clase

class TestSanMarcosScraper(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.scrapper = SanMarcosGenericScraper(self.url_base, process_name="test_proceso")
